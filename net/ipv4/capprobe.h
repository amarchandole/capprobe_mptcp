...
#define TOO_LARGE_DELAY 100000000
...
unsigned long long cap_RTT1;
unsigned long long cap_RTT2;
unsigned long long cap_RTT_SUM;
unsigned long long rtt1, rtt2, rtt, disp;

//CapProbe book keeping arrays, variables for send-receive time, serial nos.
long cap_recv_num;
long cap_serialnum[MAX_BURST_SIZE];
unsigned long long cap_send_sec[MAX_BURST_SIZE];
unsigned long long cap_send_usec[MAX_BURST_SIZE];
unsigned long long cap_recv1_sec[MAX_BURST_SIZE];
unsigned long long cap_recv1_usec[MAX_BURST_SIZE];
unsigned long long cap_recv2_sec[MAX_BURST_SIZE];
unsigned long long cap_recv2_usec[MAX_BURST_SIZE];
int cap_phase;
...
int cap_C_same2;
int cap_variance;
unsigned long long cap_C_results[3];          
unsigned long long cap_C;                 
unsigned long long cap_C_max;             
unsigned long long cap_C_min;
